...
function(build_protobuf TARGET_NAME)
  ...
  set(PROTOBUF_CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}")
  set(PROTOBUF_CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE}")
  if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    # GCC's fortified memcpy check reports a false positive in protobuf 21.12.
    string(APPEND PROTOBUF_CMAKE_CXX_FLAGS " -Wno-stringop-overflow")
    string(APPEND PROTOBUF_CMAKE_CXX_FLAGS_RELEASE
  ...
  set(OPTIONAL_ARGS
      ...
      "-DCMAKE_CXX_FLAGS=${PROTOBUF_CMAKE_CXX_FLAGS}"
      "-DCMAKE_CXX_FLAGS_RELEASE=${PROTOBUF_CMAKE_CXX_FLAGS_RELEASE}"
